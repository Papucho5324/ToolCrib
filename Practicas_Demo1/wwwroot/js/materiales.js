$(document).ready(function () {
    ...
    let tabla = $('#tablaMateriales').DataTable({
        "processing": true,
        "serverSide": false,
        "ajax": {
            ...
            "dataSrc": function (json) {
                ...
                if (json.error) {
                    Swal.fire('Error', json.message || 'Error al cargar datos', 'error');
                    return [];
                }
                return json;
            },
    ...
    $('#tablaMateriales tbody').on('click', '.edit-btn', function (e) {
        e.preventDefault();
        const id = $(this).data('id');
        window.location.href = `/Materials/Edit/${id}`;
    });

    // 📌 Eliminar material
    $('#tablaMateriales tbody').on('click', '.delete-btn', function (e) {
        e.preventDefault();
        const id = $(this).data('id');
